...
export default function Project({
  ...
  return (
    ...
    >
      <section className="hover:bg-gray-200 sm:group-even:pl-8 bg-gray-100  dark:bg-white/10 dark:hover:bg-white/20 max-w-[42rem] border-black/5 overflow-hidden relative sm:pr-8">
